<p align="center">
  <img src="docs/design/logos/mist/light/paimon-logo.png" width="120" />
  <br/>
  <em>守望 · 交互 · 掌控</em>
</p>
...
- 会话信息：侧边栏上下文进度条 + 顶部悬浮栏展示 instance name / git branch + 输入框上方内联展示 context usage / 模型
- 模型切换：输入框上方模型名可点击，弹出 Popover 按 provider 分组选择，实时同步
